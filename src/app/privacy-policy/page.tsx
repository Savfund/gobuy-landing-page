      ...
      <div className="bg-gray-100 min-h-screen py-10 px-5">
        <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
          ...
          <p className="mb-6 text-lg">
            At GoBuy, we are committed to protecting your privacy. This Privacy
            Policy explains how we collect, use, disclose, and safeguard your
            personal information when you use our website{" "}
            <a
              href="https://www.gobuy.vercel.app"
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                directly, such as your name, email address, password details
                when you register or use our services.
              </li>
              <li>
                <strong>Usage Data:</strong> Information about how you interact
                with our website, including IP address, browser type, device
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                who assist us in operating our platform (e.g., hosting services,
                mobile subscription services), bound by confidentiality
                agreements.
              </li>
              <li>
                <strong>Legal Requirements:</strong> When required by law,
                regulation, or legal process, or to protect the rights,
                property, or safety of GoBuy, our users, or the public.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                to or correction of your personal information by contacting us.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              significant updates via email or a notice on our website. Your
