  ...
  return (
    <div>
      ...
      <p>
        ...
        services. This policy was last updated on May 20, 2025.
      </p>
      ...
      <section>
        ...
        <ul>
          <li>
            ...
            directly, such as your name, email address, password details when
      ...
      <section>
        ...
        <ul>
          <li>
            To provide and maintain our services, including processing apartment
            listings and facilitating communication between users.
          </li>
          <li>
          ...
          <li>
            To send you updates, promotional offers, and service-related
            announcements (you may opt out of marketing communications).
          </li>
      ...
      <section>
        ...
        <ul>
          <li>
            ...
            assist us in operating our platform (e.g., hosting services, mobile
            subscription services), bound by confidentiality agreements.
          </li>
          <li>
            <strong>Legal Requirements:</strong> When required by law,
            regulation, or legal process, or to protect the rights, property, or
            safety of CoinBuy, our users, or the public.
          </li>
          <li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            and associated data, subject to legal retention requirements.
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          ...
          updates via email or a notice on our website. Your continued use of
          our services after changes take effect constitutes acceptance of the
          revised policy.
        </p>
      </section>
